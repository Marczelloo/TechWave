...
function Product({}: Props) {
  ...
  useEffect(() => {
    ...
    const countReviewRates = () => {
      ...
      setReviewRatesFor1(rateCounts[1] || 0)
      setReviewRatesFor2(rateCounts[2] || 0)
      setReviewRatesFor3(rateCounts[3] || 0)
      setReviewRatesFor4(rateCounts[4] || 0)
      setReviewRatesFor5(rateCounts[5] || 0)
    }
